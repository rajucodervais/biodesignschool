...
--
-- Host: localhost
-- Generation Time: Sep 20, 2020 at 01:35 PM
...
CREATE TABLE `collaborators` (
  `id` int(11) NOT NULL,
  `collab_name` varchar(250) DEFAULT NULL,
...
INSERT INTO `collaborators` (`id`, `collab_name`, `images`, `createdAt`, `updatedAt`) VALUES
(2, 'Tottori University, Japan', '1600512035482-image--014.jpg', '2020-09-19 10:40:35', '2020-09-19 10:40:35'),
(3, 'Queensland University of Technology, Australia', '1600512084934-image--013.jpg', '2020-09-19 10:41:24', '2020-09-19 10:41:24'),
(4, 'Hiroshima University, Japan', '1600512482958-image--015.jpg', '2020-09-19 10:48:02', '2020-09-19 10:48:02');
...
CREATE TABLE `start_ups` (
  ...
  `co_founder` varchar(100) DEFAULT NULL,
...
INSERT INTO `start_ups` (`id`, `image`, `logo`, `founder`, `co_founder`, `link`, `type`, `years`, `place`, `content`, `createdAt`, `updatedAt`) VALUES
(8, '1600510025475-image--002.jpg', '1600510025475-image--003.png', '', 'Amit Sharma, Nish ChashmaWala', 'https://google.com', '1', '2020', NULL, 'A new Standard of care for the short term management of fecal incontinence', '2020-09-19 10:07:05', '2020-09-19 10:07:05'),
(9, '1600510105950-image--009.jpg', '1600510105950-image--010.png', 'Jayant karve', '', 'https://google.com', '1', '2020', NULL, 'intraosseous Device- To gain Quick access to circulation in clinical emergencies', '2020-09-19 10:08:25', '2020-09-19 10:08:25'),
(12, '1600514115718-image--051.jpg', NULL, 'Darshan Nayak, Mansi Aggrawal', '', 'https://google.com', '3', '2020', 'HLL, Thiruvananthapuram', 'Limo- A better way to temporarily immobilize injured lower limbs in trauma patients before they receive definitive care', '2020-09-19 11:15:15', '2020-09-19 11:15:15'),
(13, '1600514244619-image--052.jpg', NULL, 'Shitij Malhotra, Mansi Agrawal', '', 'https://google.com', '3', '2020', 'MGM Associates, Delhi', 'Transfer Life - A simpler way to transfer non ambulatory patients from one bed to another', '2020-09-19 11:17:24', '2020-09-19 11:17:24'),
(14, '1600514376809-image--056.jpg', NULL, 'Suteerth tripathi', '', 'https://google.com', '2', '2020', '', 'Gaze- A Novel Device to Objectively Assess Vision Disorders in Children ', '2020-09-19 11:19:36', '2020-09-19 11:19:36'),
(15, '1600514480085-image--063.png', NULL, 'Gunjanbhai Patel', '', 'https://google.com', '2', '2020', '', 'An apparatus and a method for detecting and providing therapeutic treatment for sleep disorder breathing.', '2020-09-19 11:21:20', '2020-09-19 11:21:20');
...
INSERT INTO `students` (`id`, `father_name`, `full_name`, `gender`, `dob`, `house_no`, `street`, `landmark`, `state`, `city`, `pincode`, `country`, `current_house_no`, `current_street`, `current_landmark`, `current_country`, `current_city`, `current_state`, `current_pincode`, `email`, `alter_email`, `mobile`, `alter_mobile`, `nationality`, `policy_conditions`, `password`, `registration_no`, `status`, `createdAt`, `updatedAt`) VALUES
(1, 'hello', 'raju vais', '1', '2005-09-01', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'rajuvais@gmail.com', NULL, 7024674550, NULL, NULL, NULL, '$2a$10$n9YatW0lvsKslmWmqnUX4.QIM9mj02JZxCX.KhZK4euV9Kueny5TC', NULL, NULL, '2020-09-14 07:12:44', '2020-09-14 07:12:44');
